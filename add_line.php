    ...
    <div class="card shadow mb-4">
      <div class="card-header py-2">
        <div class="row row-cols-2">
          <div class="col">
            <h6 class="m-3 font-weight-bold text-success"></h6>
          </div>
      ...
      <div class="card-body">
        ...
        <form name="Line" action="add_line_db.php?ID=<?php echo $Mfg_val; ?>" method="POST" id="Line" class="form-horizontal">
          <div class="form-group row">
            <label for="colFormLabelSm" class="col-sm-2 col-form-label ">Add Line</label>
            <div class="col-sm-8">
