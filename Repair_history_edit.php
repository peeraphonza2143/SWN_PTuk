...
<div class="card shadow mb-4">
    ...
    <div class="col"><h6 class="h4 m-3 font-weight-bold text-success">Edit  </h6></div>
...
<form  name="edit" action="Repair_history_edit_db.php?ID=<?php echo $His_ID;?>&Line=<?php echo $His_Line;?>&Mfg=<?php echo $Mfg_val;?>" method="POST" id="edit" class="form-horizontal">
